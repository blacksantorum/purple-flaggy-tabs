...
public class FightDetailFragment extends Fragment {
    ...
    private static final String FIGHT_ID_PARAM = "fight_id_param";

    private int mFightId;

    private OnFragmentInteractionListener mListener;

    public static FightDetailFragment newInstance(int fightId) {
        FightDetailFragment fragment = new FightDetailFragment();
        Bundle args = new Bundle();
        args.putInt(FIGHT_ID_PARAM, fightId);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mFightId = getArguments().getInt(FIGHT_ID_PARAM);
        }
    }
